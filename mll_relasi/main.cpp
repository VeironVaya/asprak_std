...
int main() {
    ...
    do {
        cout << "\n===========================================" << endl;
        cout << "        MENU SISTEM AKADEMIK KAMPUS        " << endl;
        cout << "===========================================" << endl;
        ...
        cout << "15. Hapus MK Spesifik & Bersihkan KRS (By Nama)" << endl;
        cout << " 0. Keluar" << endl;
        cout << "===========================================" << endl;
        ...
        switch (pilihan) {
            ...
            case 12:
                ...
                if (LMK.firstMK == nullptr || LR.firstRelasi == nullptr) {
                    cout << "Belum ada MK/Mahasiswa terdaftar!" << endl;
                } else {
                    cout << "Masukkan Nama MK: "; cin >> namaTarget;
                    cout << "Masukkan NIM Mahasiswa: "; cin >> nimTarget;
                    deleteMhsDariMK(LMK, LR, namaTarget, nimTarget);
                }
                break;
            case 13:
            ...
            case 15:
                ...
                deleteMKByNama(LMK, LR, namaTarget);
                break;
            case 0:
